...
!
    function(t, e) {
        ...
        function d(t, e, n) {
            if (t && e) if (t.forEach && t.forEach === ng) t.forEach(e, n);
        ...
        function Ht(t, e, n) {
            if (e && e.length && t >= 0 && t <= 1) {
                ...
                var i = t * (e.length - 1),
                    ...
                    s = e[o],
                    l = i - r;
                return n[0] = Tt(Lt(a[0], s[0], l)), n[1] = Tt(Lt(a[1], s[1], l)), n[2] = Tt(Lt(a[2], s[2], l)), n[3] = At(Lt(a[3], s[3], l)), n
            }
        }
        function Wt(t, e, n) {
            if (e && e.length && t >= 0 && t <= 1) {
                var i = t * (e.length - 1),
                    ...
                    s = Nt(e[o]),
                    l = i - r,
                    h = Zt([Tt(Lt(a[0], s[0], l)), Tt(Lt(a[1], s[1], l)), Tt(Lt(a[2], s[2], l)), At(Lt(a[3], s[3], l))], "rgba");
                return n ? {
                    color: h,
                    leftIndex: r,
                    rightIndex: o,
        ...
        function Gt(t, e) {
            if ((t = Nt(t)) && null != e) return t[3] = At(e), Zt(t, "rgba")
        }
        function Zt(t, e) {
            if (t && t.length) {
                var n = t[0] + "," + t[1] + "," + t[2];
        ...
        function qt(t, e, n, i, r) {
            var o = t.length;
            if (1 === r) for (s = 0; s < o; s++) i[s] = Yt(t[s], e[s], n);
            else for (var a = o && t[0].length, s = 0; s < o; s++) for (var l = 0; l < a; l++) i[s][l] = Yt(t[s][l], e[s][l], n)
        }
        function $t(t, e, n) {
            var i = t.length,
                r = e.length;
            if (i !== r) if (i > r) t.length = r;
            else for (a = i; a < r; a++) t.push(1 === n ? e[a] : qg.call(e[a]));
        ...
        function Qt(t, e, n, i, r, o, a, s, l) {
            var h = t.length;
            if (1 === l) for (c = 0; c < h; c++) s[c] = Jt(t[c], e[c], n[c], i[c], r, o, a);
            else for (var u = t[0].length, c = 0; c < h; c++) for (var d = 0; d < u; d++) s[c][d] = Jt(t[c][d], e[c][d], n[c][d], i[c][d], r, o, a)
        }
                ...
                if (o || !x) {
                    ...
                    var O = new It({
                        ...
                        onframe: function(t, e) {
                            ...
                            k = n, P = e;
                            var i = m[n + 1] - m[n];
                            if (0 !== i) if (I = (e - m[n]) / i, l) if (C = v[n], T = v[0 === n ? n : n - 1], A = v[n > h - 2 ? h - 1 : n + 1], D = v[n > h - 3 ? h - 1 : n + 2], d) Qt(T, C, A, D, I, I * I, I * I * I, a(t, r), g);
                            else {
                                if (f) o = Qt(T, C, A, D, I, I * I, I * I * I, L, 1), o = ee(L);
                                else {
                                    if (p) return jt(C, A, I);
                                    o = Jt(T, C, A, D, I, I * I, I * I * I)
                                }
                                s(t, r, o)
        ...
        function Te(t, e, n, i, r, o, a, s) {
            return a ? Ae(t, e, n, i, r, a, o, s) : Ce(t, e, n, i, r, o, s)
        }
        ...
        function Be(t, e, n, i, r) {
            ...
            if (n && (l += n[0] + n[2]), t && r) {
                var h = r.outerHeight,
                    u = r.outerWidth;
                if (null != h && l > h) t = "", a = [];
                else if (null != u) for (var c = Oe(u - (n ? n[1] + n[3] : 0), e, r.ellipsis, {
                    minChar: r.minChar,
            ...
            for (k = 0; k < a.length; k++) {
                for (var p = a[k], g = 0, m = 0, v = 0; v < p.tokens.length; v++) {
                    var y = (P = p.tokens[v]).styleName && e.rich[P.styleName] || {},
                        ...
                        w = P.textHeight = C(y.textHeight, Ne(_));
        ...
        function Xe(t, e, n, i, r, o) {
            ...
            if (s || d) {
                ...
                d && (T += d[1] + d[3]);
                var C = De(x, T, w);
                s && Qe(t, e, i, C, S, T, g), d && (M = an(x, w, d), I += d[0])
            }
            ...
            var L = i.textStrokeWidth,
                ...
                N = nn(i.textStroke, L),
                R = rn(i.textFill);
            if (N && (z && (e.lineWidth = L), E && (e.strokeStyle = N)), R && (l && i.textFill === a.textFill || (e.fillStyle = R)), 1 === m.length) N && e.strokeText(m[0], M, I), R && e.fillText(m[0], M, I);
            else for (var B = 0; B < m.length; B++) N && e.strokeText(m[B], M, I), R && e.fillText(m[B], M, I), I += v
        }
        ...
        function je(t, e, n, i, r) {
            ...
            for (var x = 0; x < n.lines.length; x++) {
                for (var _, w = n.lines[x], b = w.tokens, S = b.length, M = w.lineHeight, I = w.width, T = 0, C = m, A = y, D = S - 1; T < S && (!(_ = b[T]).textAlign || "left" === _.textAlign);) $e(t, e, _, i, M, v, C, "left"), I -= _.width, C += _.width, T++;
                for (; D >= 0 && "right" === (_ = b[D]).textAlign;) $e(t, e, _, i, M, v, A, "right"), I -= _.width, A -= _.width, D--;
                for (C += (o - (C - m) - (y - A) - I) / 2; T <= D;) $e(t, e, _ = b[T], i, M, v, C + _.width / 2, "center"), C += _.width, T++;
                v += M
            }
        }
        ...
        function li(t, e, n, i, r, o, a, s, l, h) {
            ...
            for (l[0] = 1 / 0, l[1] = 1 / 0, h[0] = -1 / 0, h[1] = -1 / 0, u = 0; u < f; u++) {
                var p = d(t, n, r, a, Cv[u]);
                l[0] = xv(p, l[0]), h[0] = _v(p, h[0])
            }
            for (f = c(e, i, o, s, Av), u = 0; u < f; u++) {
                var g = d(e, i, o, s, Av[u]);
                ...
                for (var m = 0; m < p;) {
                    ...
                    switch (d) {
                        ...
                        case "S":
                            ...
                            var T = a.len(),
                                C = a.data;
                            e === s.C && (v += n - C[T - 4], y += i - C[T - 3]), u = s.C, M = f[m++], I = f[m++], n = f[m++], i = f[m++], a.addData(u, v, y, M, I, n, i);
                            break;
                        case "s":
                            v = n, y = i;
                            var T = a.len(),
                                C = a.data;
                            e === s.C && (v += n - C[T - 4], y += i - C[T - 3]), u = s.C, M = n + f[m++], I = i + f[m++], n += f[m++], i += f[m++], a.addData(u, v, y, M, I, n, i);
                            break;
                        case "Q":
                        ...
                        case "T":
                            ...
                            var T = a.len(),
                                C = a.data;
                            e === s.Q && (v += n - C[T - 4], y += i - C[T - 3]), n = f[m++], i = f[m++], u = s.Q, a.addData(u, v, y, n, i);
                            break;
                        case "t":
                            v = n, y = i;
                            var T = a.len(),
        ...
        function fo(t, e, n, i, r) {
            ...
            if (e === _x)"auto" === i || null == i ? go(function(t) {
                ...
                r[e] = null != t ? t : ""
            }, n, t)), o = r ? r.length : n === Cx ? t.length : t[0] ? t[0].length : null;
        ...
        function go(t, e, n, i) {
            if (null == i && (i = 1 / 0), e === Cx) for (o = 0; o < n.length && o < i; o++) t(n[o] ? n[o][0] : null, o);
        ...
        function _o(t, e, n, i, r, o) {
            ...
            if (S(t)) return !1;
            var l;
            if (i && (l = w(l = i[o]) ? l.name : l), e === _x) if (n === Cx) {
        ...
        function ga() {
            this.group = new am, this.uid = Ar("viewChart"), this.renderTask = ia({
                plan: ya,
                reset: xa
            ...
            for (var c = 0, d = n, f = 0; f < i; f++) {
                ...
                if (d === n) t[o > 0 ? "moveTo" : "lineTo"](p[0], p[1]);
                    ...
                    var g = e[c],
                        m = "y" === h ? 1 : 0,
                        v = (p[m] - g[m]) * l;
                    Tb(Ab, g), Ab[m] = g[m] + v, Tb(Db, p), Db[m] = p[m] - v, t.bezierCurveTo(Ab[0], Ab[1], Db[0], Db[1], p[0], p[1])
        ...
        function Sh(t, e, n, i, r, o, a, s, l, h, u) {
            for (var c = 0, d = n, f = 0; f < i; f++) {
                ...
                if (d === n) t[o > 0 ? "moveTo" : "lineTo"](p[0], p[1]), Tb(Ab, p);
                else if (l > 0) {
                    var g = d + o,
                        m = e[g];
                    ...
                    if (!(m = e[g]) || _h(m)) Tb(Db, p);
                        ...
                        Ib(Db, p, Cb, -l * (1 - (v = _ / (_ + x))))
                    }
                    Sb(Ab, Ab, s), Mb(Ab, Ab, a), Sb(Db, Db, s), Mb(Db, Db, a), t.bezierCurveTo(Ab[0], Ab[1], Db[0], Db[1], p[0], p[1]), Ib(Ab, p, Cb, l * v)
                } else t.lineTo(p[0], p[1]);
                c = d, d += o
            }
            return f
        ...
        function Hh(t, e, n, i) {
            ...
            if (l) {
                ...
                else for (var u in a) if (a.hasOwnProperty(u) && Wh(a[u]) && !i[r(a[u])]) {
                    o = a[u];
                    break
                }
                o && (i[r(o)] = !0)
        ...
        function Wh(t) {
            return t && "category" !== t.type && "time" !== t.type && Al(t)
        }
        function Gh(t, e) {
            var n = t.getExtent(),
                i = n[0] + n[1];
        ...
        function Cu(t, e, n, i, r, o) {
            for (var a = [], s = [], l = 0; l < t.length; l++) Au(t[l]) || (t[l].x < e ? a.push(t[l]) : s.push(t[l]));
            Tu(s, e, n, i, 1, r, o), Tu(a, e, n, i, -1, r, o);
            for (l = 0; l < t.length; l++) if (!Au(t[l])) {
        ...
        function ff(t, e) {
            var r = t._zr;
            t._enableGlobalPan || Cd(r, eI, t._uid), YM(t._handlers, function(t, e) {
                r.on(e, t)
            }), t._brushType = e.brushType, t._brushOption = i(n(rI), e, !0)
        }
        function pf(t) {
            var e = t._zr;
            Ad(e, eI, t._uid), YM(t._handlers, function(t, n) {
                e.off(n, t)
        ...
        var Ag = "undefined" == typeof Float32Array ? Array : Float32Array,
        ...
        var Gg = {
            ...
            jg = (Object.freeze || Object)({
                ...
                modifyHSL: function(t, e, n, i) {
                    if (t = Nt(t)) return t = Bt(t), null != e && (t[0] = Ct(e)), null != n && (t[1] = kt(n)), null != i && (t[2] = kt(i)), Zt(Rt(t), "rgba")
                },
                modifyAlpha: Gt,
                stringify: Zt
            }),
        ...
        hm.prototype = {
            ...
            delRoot: function(t) {
                ...
                if (t instanceof Array) for (var n = 0, i = t.length; n < i; n++) this.delRoot(t[n]);
                else {
        ...
        var wm = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.msRequestAnimationFrame && window.msRequestAnimationFrame.bind(window) || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) ||
            function(t) {
                setTimeout(t, 16)
            }, bm = new Hg(50), Sm = {}, Mm = 0, Im = 5e3, Tm = /\{([a-zA-Z0-9_]+)\|([^}]*)\}/g, Cm = "12px sans-serif", Am = {};
        Am.measureText = function(t, e) {
            var n = s();
            return n.font = e || Cm, n.measureText(t)
        };
        var Dm = Cm,
            km = {
                left: 1,
        ...
        var Bm = function(t) {
            t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe ||
                function() {}, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, xg.call(this)
        };
        Bm.prototype = {
            constructor: Bm,
            addClip: function(t) {
        ...
        var Um = !Kp.canvasSupported,
            ...
            jm = function(t, e, n) {
                ...
                this.handler = new Cg(r, a, s, a.root), this.animation = new Bm({
                    stage: {
        ...
        var fy = Ii.extend({
            ...
            gy = function(t) {
                return Kp.browser.ie && Kp.browser.version >= 11 ?
                    function() {
            ...
            Ay = Ii.extend({
                ...
                buildPath: function(t, e) {
                    var n = e.x1,
                        ...
                        h = e.cpy2,
                        u = e.percent;
                    0 !== u && (t.moveTo(n, i), null == l || null == h ? (u < 1 && (ri(n, a, r, u, Cy), a = Cy[1], r = Cy[2], ri(i, s, o, u, Cy), s = Cy[1], o = Cy[2]), t.quadraticCurveTo(a, s, r, o)) : (u < 1 && (Qn(n, a, l, r, u, Cy), a = Cy[1], l = Cy[2], r = Cy[3], Qn(i, s, h, o, u, Cy), s = Cy[1], h = Cy[2], o = Cy[3]), t.bezierCurveTo(a, s, l, h, r, o)))
                },
                pointAt: function(t) {
        ...
        Ir.prototype = {
            ...
            get: function(t, e) {
                return null == t ? this.option : Tr(this.option, this.parsePath(t), !e && Cr(this, t))
            },
            ...
            getModel: function(t, e) {
                ...
                return e = e || (n = Cr(this, t)) && n.getModel(t), new Ir(i, e, this.ecModel)
            },
            isEmpty: function() {
        ...
        var qy = 0,
            ...
            fx = Ir.extend({
                ...
                $constructor: function(t, e, n, i) {
                    Ir.call(this, t, e, n, i), this.uid = Ar("ec_cpt_model")
                },
                ...
                if (t.length) {
                    ...
                    for (d(t, function(t) {
                        ...
                        var u = l.pop(),
                            c = s[u],
                            f = !! h[u];
                        f && (i.call(r, u, c.originalDeps.slice()), delete h[u]), d(c.successor, f ?
                            function(t) {
                                h[t] = !0, o(t)
                            } : o)
                    }
        ...
        var Ax = On(),
            ...
            kx = Ir.extend({
                ...
                findComponents: function(t) {
                    ...
                    }(Co(i ? this.queryComponents(i) : this._componentsMap.get(n), t))
                },
        ...
        var Xx = {
            ...
            jx = {
                ...
                original: function(t, e, n, i) {
                    ...
                    return !this._rawData.pure && Cn(t) && (this.hasItemOption = !0), ta(r instanceof Array ? r[i] : r, this._dimensionInfos[e])
                },
        ...
        Kx.perform = function(t) {
            ...
            if (this._dueEnd = n ? n._outputDueEnd : this._count ? this._count(this.context) : 1 / 0, this._progress) {
                ...
                if (!i && (u || d < f)) {
                    ...
                    if (y(p)) for (var g = 0; g < p.length; g++) oa(this, p[g], d, f, l, h);
        ...
        u(t_, $x), u(t_, vx);
        var e_ = function() {
            this.group = new am, this.uid = Ar("viewComponent")
        };
        e_.prototype = {
            constructor: e_,
            init: function(t, e) {},
        ...
        var s_ = {
            ...
            f_ = function(t, e) {
                ...
                if (o.get("show")) if (o.get("description")) t.setAttribute("aria-label", o.get("description"));
                else {
                    var a = 0;
        ...
        Sa.wrapStageHandler = function(t, e) {
            return x(t) && (t = {
                overallReset: t,
                seriesType: Na(t)
            }), t.uid = Ar("stageHandler"), e && (t.visualType = e), t
        };
        var y_, x_ = {},
            __ = {};
        Ra(x_, kx), Ra(__, Ao), x_.eachSeriesByType = x_.eachRawSeriesByType = function(t) {
            y_ = t
        ...
        Mw.type = "list", Mw.hasItemOption = !0, Mw.getDimension = function(t) {
            ...
            if (!(t >= e)) {
                ...
                for (var m = new Array(s), v = t; v < e; v++) {
                    ...
                    if (!r.pure) {
                        var I = h[v];
                        if (m && null == I) if (null != m.name) h[v] = I = m.name;
                        else if (null != n) {
                            var T = a[n],
                                C = o[T][y];
                            if (C) {
            ...
            if (pw(t)) for (var n in t) t.hasOwnProperty(n) && this.setVisual(n, t[n]);
            else this._visual = this._visual || {}, this._visual[t] = e
        }, Mw.setLayout = function(t, e) {
            if (pw(t)) for (var n in t) t.hasOwnProperty(n) && this.setLayout(n, t[n]);
            ...
            if (this._itemVisuals[t] = i, pw(e)) for (var o in e) e.hasOwnProperty(o) && (i[o] = e[o], r[o] = !0);
            else i[e] = n, r[e] = !0
            ...
            render: function(t, e, n) {
                ...
                if (I = Th(t.get("smooth")), f.setShape({
                    ...
                    p.useStyle(a(l.getAreaStyle(), {
                        ...
                        opacity: .7,
                        lineJoin: "bevel"
                    })), T && (C = Th(T.get("smooth"))), p.setShape({
                        smooth: I,
                        stackedOnSmooth: C,
                        smoothMonotone: t.get("smoothMonotone"),
                        connectNulls: t.get("connectNulls")
            ...
            function i(n) {
                return function(i, s) {
                    if (Fh(i, t, e)) {
                        ...
                        var h = new Rb(n, Cl(i), [0, 0], i.get("type"), l),
                            u = "category" === h.type;
            ...
            d(n, function(t) {
                ...
                for (var d = e.mapDimension(u.dim), f = e.mapDimension(o.dim), p = tl(e, d), g = u.isHorizontal(), m = bl(0, u), v = 0, y = e.count(); v < y; v++) {
                    ...
                    if (!isNaN(x)) {
                        ...
                        var S, M, I, T;
                        if (g) S = b, M = (C = n.dataToPoint([x, _]))[1] + l, I = C[0] - m, T = h, Math.abs(I) < c && (I = (I < 0 ? -1 : 1) * c), p && (r[a][_][w] += I);
                        else {
                            var C = n.dataToPoint([_, x]);
                            S = C[0] + l, M = b, I = h, T = C[1] - m, Math.abs(T) < c && (T = (T <= 0 ? -1 : 1) * c), p && (r[a][_][w] += T)
                        }
                        e.setItemLayout(v, {
                            x: S,
                            y: M,
        ...
        var fS = function(t, e, n, i) {
                ...
                }), !l && t.get("avoidLabelOverlap") && Cu(s, r, o, e, n, i)
            },
            pS = 2 * Math.PI,
            gS = Math.PI / 180;
        !
        ...
        (ec.prototype = {
            ...
            createPointerEl: function(t, e, n, i) {
                var r = e.pointer;
                if (r) {
                    var o = TS(t).pointerEl = new Wy[r.type](CS(e.pointer));
                    t.add(o)
                }
            },
        ...
        As({
            ...
            _updatePosition: function(t, e, n, i, r, o, a) {
                ...
                if (u && (n -= Cc(u) ? h[0] / 2 : "right" === u ? h[0] : 0), c && (i -= Cc(c) ? h[1] / 2 : "bottom" === c ? h[1] : 0), t.get("confine")) {
                    var p = Ic(n, i, r, s, l);
                    n = p[0], i = p[1]
                }
                r.moveTo(n, i)
        ...
        bs("legendToggleSelect", "legendselectchanged", v(Ac, "toggleSelected")), bs("legendSelect", "legendselected", v(Ac, "select")), bs("legendUnSelect", "legendunselected", v(Ac, "unSelect"));
        var FS = v,
            VS = d,
            HS = am,
            WS = As({
        ...
        var AI, DI = "urn:schemas-microsoft-com:vml",
            kI = "undefined" == typeof window ? null : window,
            PI = !1,
            LI = kI && kI.document;
        if (LI && !Kp.canvasSupported) try {
            !LI.namespaces.zrvml && LI.namespaces.add("zrvml", DI), AI = function(t) {
                        ...
                        switch (r = p[o++], i = "", n = 0, r) {
                            ...
                            case c:
                                ...
                                var O = p[o++],
                                    ...
                                    x = A + BI(L) * k,
                                    N = O ? " wa " : " at ";
                                Math.abs(z - y) < 1e-4 && (Math.abs(L - P) > .01 ? O && (z += .0125) : Math.abs(E - A) < 1e-4 ? O && z < C || !O && z > C ? x -= .0125 : x += .0125 : O && E < A || !O && E > A ? y += .0125 : y -= .0125), f.push(N, zI(((C - D) * M + b) * VI - HI), ",", zI(((A - k) * I + S) * VI - HI), ",", zI(((C + D) * M + b) * VI - HI), ",", zI(((A + k) * I + S) * VI - HI), ",", zI((z * M + b) * VI - HI), ",", zI((E * I + S) * VI - HI), ",", zI((y * M + b) * VI - HI), ",", zI((x * I + S) * VI - HI)), a = y, s = x;
                                break;
                            case OI.R:
                                var R = tT[0],
                                    B = tT[1];
            ...
            hn.prototype.brushVML = function(t) {
                ...
                if (r) {
                    ...
                    if (this.transform && (x = this.transform, b = EI(x[0] * x[0] + x[1] * x[1]), S = EI(x[2] * x[2] + x[3] * x[3]), w = x[1] || x[2]), w) {
                        ...
                        var A = FI(M[0], I[0], T[0], C[0]),
                            D = FI(M[1], I[1], T[1], C[1]),
                            k = [];
                        k.push("M11=", x[0] / b, ",", "M12=", x[2] / S, ",", "M21=", x[1] / b, ",", "M22=", x[3] / S, ",", "Dx=", zI(h * b + x[4]), ",", "Dy=", zI(u * S + x[5])), _.padding = "0 " + zI(A) + "px " + zI(D) + "px 0", _.filter = "progid:DXImageTransform.Microsoft.Matrix(" + k.join("") + ", SizingMethod=clip)"
            ...
            for (var lT = new se, hT = [zm, ln, hn, Ii, dy], uT = 0; uT < hT.length; uT++) {
                ...
                cT.drawRectText = function(t, e, n, i) {
                    ...
                    if (null != o && (o += ""), o) {
                        ...
                        var T = [c, d],
                            C = I.style;
                        v && i ? ($(T, T, v), S.on = !0, S.matrix = v[0].toFixed(3) + "," + v[2].toFixed(3) + "," + v[1].toFixed(3) + "," + v[3].toFixed(3) + ",0,0", S.offset = (zI(T[0]) || 0) + "," + (zI(T[1]) || 0), S.origin = "0 0", C.left = "0px", C.top = "0px") : (S.on = !1, C.left = zI(c) + "px", C.top = zI(d) + "px"), b.string = GI(o);
                        try {
                            b.style.font = m
                        } catch (t) {}
                        JI(I, "fill", {
        ...
        ST.brush = function(t) {
            ...
            Ap(n, e, !1, t), Ip(n, t.transform), null != e.text && CT(t, t.getBoundingRect())
        };
        var MT = {};
        MT.brush = function(t) {
            var e = t.style,
            ...
            if (n instanceof HTMLImageElement && (n = n.src), n) {
                var i = e.x || 0,
                    ...
                    a = e.height,
                    s = t.__svgEl;
                s || (s = _p("image"), t.__svgEl = s), n !== t.__imageSrc && (Cp(s, "href", n), t.__imageSrc = n), Tp(s, "width", o), Tp(s, "height", a), Tp(s, "x", i), Tp(s, "y", r), Ip(s, t.transform), null != e.text && CT(t, t.getBoundingRect())
            }
        };
        var IT = {},
            TT = new se,
            CT = function(t, e, n) {
                ...
                if (null != r) {
                    ...
                    var c = i.font || [i.fontStyle || "", i.fontWeight || "", i.fontSize || "", i.fontFamily || ""].join(" ") || Cm,
                    ...
                    var g = i.textPadding;
                    if (Tp(o, "x", a), Tp(o, "y", s), Ap(o, i, !0, t), t instanceof dy || t.style.transformText) Ip(o, t.transform);
                    else {
                    ...
                    if ("after-edge" === d ? (S = -n.height + f, g && (S -= g[2])) : "middle" === d ? (S = (-n.height + f) / 2, g && (s += (g[0] - g[2]) / 2)) : g && (S += g[0]), t.__text !== r || t.__textFont !== c) {
                        var M = t.__tspanList || [];
                        t.__tspanList = M;
                        for (T = 0; T < w; T++)(C = M[T]) ? C.innerHTML = "" : (C = M[T] = _p("tspan"), o.appendChild(C), Tp(C, "alignment-baseline", d), Tp(C, "text-anchor", b)), Tp(C, "x", a), Tp(C, "y", s + T * f + S), C.appendChild(document.createTextNode(_[T]));
                        ...
                        C && (Tp(C, "x", a), Tp(C, "y", s + T * f + S))
                    }
                }
            };
        IT.drawRectText = CT, IT.brush = function(t) {
            var e = t.style;
            null != e.text && (e.textPosition = [0, 0], CT(t, {
                x: e.x || 0,
                y: e.y || 0,
                width: 0,
                height: 0
        ...
        }, t.registerLayout = Ss, t.registerVisual = Ms, t.registerLoading = Ts, t.extendComponentModel = Cs, t.extendComponentView = As, t.extendSeriesModel = Ds, t.extendChartView = ks, t.setCanvasCreator = function(t) {
            e("createCanvas", t)
